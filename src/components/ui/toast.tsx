...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      ...
      "flex max-h-screen w-[380px] flex-col gap-3 p-0 outline-none",
...
const toastVariants = cva(
  [
    "group pointer-events-auto relative w-full overflow-hidden rounded-2xl border",
    "px-4 py-3 pr-8 shadow-card",
    "transition-all",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 items-center justify-center rounded-lg border px-3 text-sm font-medium",
